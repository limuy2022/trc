...
static inline char * ERROR_TYPE_MSG(const char *type_name) {
    char * res = new char[strlen(language::TVM::type_change_error_msg) + strlen(type_name) + 1];
...
static inline char * ERROR_OPER_MSG(const char *type_name) {
    char * res = new char[strlen(language::TVM::oper_not_def_error_msg) + strlen(type_name) + 1];
    ...
    namespace TVM_space {
        namespace types {
            ...
            def::OBJ trcobj::to_int() {
                ...
                error::send_error(error::TypeError, error_msg);
                delete []error_msg;
                return nullptr;
            }
            ...
            def::INTOBJ trcobj::operator<(def::OBJ value_i) {
                ...
                error::send_error(error::SyntaxError, error_msg);
                delete []error_msg;
