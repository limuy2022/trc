...
#define TRC_Compiler_c_api extern "C" __declspec(dllexport)
#else
#define TRC_Compiler_api __declspec(dllimport)
#define TRC_Compiler_c_api extern "C" __declspec(dllimport)
#endif
#else
#define TRC_Compiler_api __attribute__((visibility("default")))
#define TRC_Compiler_c_api extern "C" __attribute__((visibility("default")))
#endif
#else
