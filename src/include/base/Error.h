 ...
 * %", "int", "string") @endcode
 */
TRC_base_func_api void send_error_module_aplist(int name,
 ...
 */
TRC_base_func_api char* make_error_msg(
    int error_name, va_list& ap);
 ...
 */
TRC_base_func_api void send_error_(const char* error_msg,
    const char* module, size_t line_index) noexcept;
}
